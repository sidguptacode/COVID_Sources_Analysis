...
```{r top-no-info-plot, echo = FALSE, message=FALSE, fig.cap="Comparing the income indices of the top 30 neighbourhoods with high proportions of no source information.", warning=FALSE}
...
```{r bot-no-info-plot, echo = FALSE, message=FALSE, warning=FALSE, fig.cap="Comparing the income indices of the bottom 30 neighbourhoods with high proportions of no source information."}
