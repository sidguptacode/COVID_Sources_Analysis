...
#source(here::here("scripts/01-data_download.R"), local = knitr::knit_global()) # TODO: Uncomment
...
```{r cases-timepoints-plot, echo = FALSE, message=FALSE, fig.cap="TODO", warning=FALSE}
normalize_dfs_and_barplot(counts_for_reported_date, "n", reported_data_noinfo_prop_sorted, "prop", "reported_date", "Month and year", " Normalized case count / proportion", "Lowest-30 neighbourhoods for responding with no source information against income index", TRUE, TRUE) 
```
...
```{r top-no-info-plot, echo = FALSE, message=FALSE, fig.cap="TODO", warning=FALSE}
normalize_dfs_and_barplot(top_noinfo_neighbs, "prop", income_data_of_topneighbs_df, "income_index", "neighbourhood_name","Neighbourhood", "Normalized income index / proportion", "Top-30 neighbourhoods for responding with no source information against income index", FALSE, FALSE) 
```

```{r bot-no-info-plot, echo = FALSE, message=FALSE, fig.cap="TODO", warning=FALSE}
normalize_dfs_and_barplot(bottom_noinfo_neighbs, "prop", income_data_of_botneighbs_df, "income_index", "neighbourhood_name", "Income Index", " Neighbourhood", "Bottom-30 neighbourhoods for responding with no source information against income index", FALSE, FALSE) 
```
